...
export const SIDEBAR_CONFIG: Record<ProductKey, SidebarItem[]> = {
  ...
  evidencia: [
    { id: 'overview', label: 'Visão geral', iconKey: 'LayoutGrid' },
    { id: 'viewer', label: 'Visualizador', iconKey: 'Images' },
    { id: 'inspections', label: 'Vistorias', iconKey: 'ClipboardCheck' },
    { id: 'custody', label: 'Cadeia de custódia', iconKey: 'Link2' },
    { id: 'map', label: 'Mapa', iconKey: 'Map' },
    { id: 'agents', label: 'Agentes', iconKey: 'Bot' },
    { id: 'reports', label: 'Relatórios', iconKey: 'FileText' },
  ],
  ativos: [
    { id: 'overview', label: 'Visão geral', iconKey: 'LayoutGrid' },
    { id: 'portfolio', label: 'Portfólio', iconKey: 'Building2' },
    { id: 'map', label: 'Mapa', iconKey: 'Map' },
    { id: 'health', label: 'Saúde', iconKey: 'HeartPulse' },
    { id: 'maintenance', label: 'Manutenção', iconKey: 'Wrench' },
    { id: 'analytics', label: 'Analytics', iconKey: 'BarChart3' },
    { id: 'agents', label: 'Agentes', iconKey: 'Bot' },
    { id: 'reports', label: 'Relatórios', iconKey: 'FileText' },
    { id: 'integrations', label: 'Integrações', iconKey: 'Plug' },
  ...
  impacto: [
    { id: 'overview', label: 'Visão geral', iconKey: 'LayoutGrid' },
    { id: 'indicators', label: 'Indicadores', iconKey: 'Target' },
    { id: 'beneficiaries', label: 'Beneficiários', iconKey: 'Users' },
    { id: 'map', label: 'Mapa', iconKey: 'Map' },
    { id: 'reports', label: 'Relatórios', iconKey: 'FileText' },
    { id: 'admin', label: 'Administração', iconKey: 'Settings' },
  ],
